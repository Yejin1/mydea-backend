...
import com.mydea.mydea_backend.security.JwtAuthFilter;
...
class WorkControllerTest {
        ...
        // Mock security infrastructure beans to avoid full security wiring issues in
        // slice test
        @MockitoBean
        ...
        void create() throws Exception {
                ...
                given(workService.create(any(WorkRequest.class), eq(1L))).willReturn(saved);
        ...
        class SignedPreviewUrl {
                ...
                void ok_when_canonical_exists() throws Exception {
                        ...
                        given(blobSasService.issueReadSasUrl(eq("https://blob/works/5/preview.png"),
